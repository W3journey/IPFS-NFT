...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    /**
     * @dev _baseURI overides the Openzeppelin ERC721 implementation which by default
    ...
    /**
     * @dev tokenURI overrides the Openzeppelin ERC721 implementation for tokenURI function
    ...
    function tokenURI(
        ...
        // Here we check if the length of the baseURI is greater than 0, if it is return the baseURI and attach
